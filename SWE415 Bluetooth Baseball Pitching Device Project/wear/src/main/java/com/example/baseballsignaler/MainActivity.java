    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnEnableDisable_Discoverable.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                viewFlipper.setDisplayedChild(viewFlipper.indexOfChild(findViewById(R.id.begin_discovering)));
            }
        });

        btnFindDiscoverableDevices.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                btnDiscover();
                viewFlipper.setDisplayedChild(viewFlipper.indexOfChild(findViewById(R.id.begin_connection)));
            }
        });
